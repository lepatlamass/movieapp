...
public class FavoriteDbHelper extends SQLiteOpenHelper {
    private static final String DATAABASE_NAME = "favorite.db";
    ...
    public void deleFavorite(int id) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(FavoriteContract.FavoriteEntry.TABLE_NAME, FavoriteContract.FavoriteEntry.COLUMN_MOVIEID+ "=", null);
    }
